...
save(kyldat,file="../data/kyldata.RData")
...
The results suggest both total P and the dispersal difficulty matrix
are necessary to explain the synchrony matrix for chlorophyll. Now
use model selection to work out relative importances. A typical
use of the package just uses `mmsmodwts` and `mmsvarwts`:
```{r model_sel}
